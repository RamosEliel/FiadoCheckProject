...
export default function TiendasTabScreen() {
  const {
    tiendas,
    loading,
    tiendaSeleccionada,
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right', 'bottom']}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Tus tiendas</Text>
        <Text style={styles.headerSubtitle}>
          Elige la tienda que quieres consultar. Solo aparecen las que tienen saldo pendiente.
        </Text>
      </View>
          ...
          {loading ? (
            ...
            <>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
              >
                <Text style={styles.btnPrimaryText}>Ver cuenta</Text>
              </TouchableOpacity>
            </>
          )}
        </View>
